...
{
[System.Flags]
public enum UserJoints 												/// <summary>User Joints and their respective combinations.</summary>
{
	None = 0, 														/// <summary>No User Joint.</summary>
	Head = 3, 														/// <summary>Head's User Joint.</summary>
	Torax = 5, 														/// <summary>Torax's User Joint.</summary>
	Left = 1, 														/// <summary>Left Orientation User Joint.</summary>
	Right = 2, 														/// <summary>Right Orientation User Joint.</summary>
	Hand = 16, 														/// <summary>Hand's User Joint.</summary>
	Paddle = 32, 													/// <summary>Paddle's User Joint.</summary>

	LeftHand = Left | Hand, 										/// <summary>Left Hand's User Joint.</summary>
	RightHand = Right | Hand, 										/// <summary>Right Hand's User Joint.</summary>
	LeftPaddle = Left | Paddle, 									/// <summary>Left Paddle's User Joint.</summary>
	RightPaddle = Right | Paddle 									/// <summary>Right Paddle's User Joint.</summary>
}
...
#region YeOldeWay:
	private OrientationSemantics GetOrientation(Transform _centralJoint, Vector3 _childJointPosition, Vector3? _distanceThreshold = null)
	{
		...
		orientation |= relativePoint.z > _distanceThreshold.Value.z ? OrientationSemantics. Forward : relativePoint.z < -_distanceThreshold.Value.z ? OrientationSemantics.Backward : OrientationSemantics.None;
